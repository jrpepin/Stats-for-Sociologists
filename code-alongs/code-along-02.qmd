...
gss24$________ <- as_factor(gss24$________) # replaces the values with labels
table(gss24$________, useNA = "ifany") # no longer need to wrap the variable in as_factor
```
...
gss24$________ <- droplevels(gss24$________)
