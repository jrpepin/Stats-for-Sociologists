...
Political polarization is high in the U.S. today.
...
Let's use `zap_missing` and `as_factor` to clean these up for `premarsex`. 
<br>
...
For `polviews`, let's combine categories to make it easier to interpret. 
This is easier to do when the values remain as numbers.  
...
#gss24 %>%
# mutate(poldum = case_when(
 #  polviews ))
```

Tip: [pipes](https://www.tidyverse.org/blog/2023/04/base-vs-magrittr-pipe/)
...
missing values. Then, do the same for `polviews`.
...
## Pretty Frequency Table {.smaller}

:::::: columns
::: {.column width="70%"}

```{r}
#| label: freq.02-polviews
...
-   [8.52]{.correct data-explanation="💯 Correct!"}
-   [24.71]{data-explanation="😲 This is the % who think premartial sex is 'always wrong'."}
-   [33.23]{data-explanation="😲 This is the % who think premarital sex is 'always' OR 'almost always wrong'."}
-   [19.05]{data-explanation="😲 This is % who think premarital sex is 'wrong only sometimes'."}
...
-   [33.23]{.correct data-explanation="💯 Correct!"}
-   [24.71]{data-explanation="😲 This is the % who think premartial sex is 'always wrong'."}
-   [8.52]{data-explanation="😲 This is the % who think premarital sex is 'almost always wrong'."}
-   [19.05]{data-explanation="😲 This is % who think premarital sex is 'wrong only sometimes'."}
