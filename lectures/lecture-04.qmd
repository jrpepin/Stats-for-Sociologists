...
## Assignment: Overwriting {.smaller .sparse-slide}
...
## Assignment: Overwriting (cont) {.smaller .sparse-slide}
...
On average, in 2024, did married people watch more or less television that never married people? What about compared to widowed/divorced/separated people?
...
Use `select()`, `filter()`, `mutate()`, `group_by()`, and `summarise()`
