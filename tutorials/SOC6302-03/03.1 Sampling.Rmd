...
![](images/snail03.png "Blue cartoon snail looking alert."){width="25%"}
...
![](images/stratified.png){width="50%"}

  
### Central Limit Theorem  

![](images/not_normal.png "Normal distribution vs a paranomral distribution (ghost)"){ width=50% }
...
![](images/love.jpg "Love letter from a statistician: You're 3 SD above the norm."){ width=50% }
...
Learning Check #03 {data-progressive=TRUE}
------------------------------------------------------------------------------------------
