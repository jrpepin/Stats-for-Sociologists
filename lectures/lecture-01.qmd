...
The top-left panel (source pane) and can be launched by opening any editable file in
RStudio.
:::
::::
...
## Your first code-along {data-menu-title="Code-along" background-image="images/terminal.png"}

<br>

<a href="https://github.com/jrpepin/joannapepin.github.io/raw/main/files/code-alongs/code-along-01.qmd" download class="btn btn-primary">
  <i class="fa fa-download"></i> Download code-along-01.qmd
</a>

[code-along-01.qmd](/code-alongs/code-along-01.qmd)
