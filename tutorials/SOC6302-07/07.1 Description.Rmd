...
```{r Q06, echo=FALSE}
  question("What is wrong with the pie chart?",
...
```{r Q07, echo=FALSE}
  question("___________ helps the researcher interpret and understand data, whereas ___________ is used to persuade viewers to believe or do something.",
...
```{r Q08, echo=FALSE}
  question("According to your reading, the NYTimes 500,000 dots data visualization of COVID-19 deaths suggests which of the following about data visualization?",
...
```{r Q09, echo=FALSE}
  question("Aside from the chart junk, why is this example chart from Cairo (2019) misleading?",
...
```{r Q10, echo=FALSE}
  question("Why is the line chart above misleading?",
