...
1.  Wheelan, Charles. 2014. “Descriptive Statistics: Who Was the Best Baseball Player of All Time?” Pp. 15–35 in *Naked Statistics: Stripping the Dread from the Data*. New York: W. W. Norton & Company.

2.  Wickham, Hadley, Mine Cetinkaya-Rundel, and Garrett Grolemund. 2023. “[Data Transformation](https://r4ds.hadley.nz/data-transform.html).” in *R for Data Science: Import, Tidy, Transform, Visualize, and Model Data*. Beijing Boston Farnham Sebastopol Tokyo: O’Reilly Media.
...
${\color{mathGreen} 17} + {\color{mathOrange} 7} = {\color{mathRed} 24\%}$
...
```{r Q11, echo=FALSE}
  question("Q11. A baseball analyst compares batting average, home runs, and on-base percentage to determine the greatest player of all time. Each statistic identifies a different player as the best. According to Charles Wheelan, what is the main lesson of this example?",
    answer("Descriptive statistics are useful summaries, but different statistics can lead to different conclusions about the same data.",  correct = TRUE),
    answer("The best player is the one who performs well across the largest number of statistics."),
    answer("Batting average is the single best measure of player performance."),
    answer("Descriptive statistics are useful summaries, but analysts should choose the one statistic that best captures overall performance."),
         random_answer_order = TRUE,
         allow_retry = TRUE    )
```

```{r Q12, echo=FALSE}
  question("Q12. According to Wickham, Cetinkaya-Rundel, and Grolemund's *Data Transformation*, which of these tests for equality?",
    answer("==",  correct = TRUE),
    answer("=",  message = "Typically used to set argument values."),
    answer("|>",  message = "This is a pipe, which generally means *then*."),
    answer("<=",  message = "This means less than or equal to."),
         random_answer_order = TRUE,
         allow_retry = TRUE    )
```
