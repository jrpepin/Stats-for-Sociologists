...
code-along-01.qmd](https://www.dropbox.com/scl/fi/dwa4lo3twg3tclza8jcm7/code-along-01.qmd?rlkey=u71pkl2vaw2fsgv1d0n4rgwza&dl=1)
...
## Mini-task {.sparse-slide data-menu-title="Load the packages"}

::: task
{{< fa check-double >}} Load the packages.
:::
...
organized in structured, clear rows and columns. “(3,986 × 989)”
means the dataset contains 3,986 rows and 989 columns. Commonly, in
social sciences, rows are referred to as “observations” and columns as “variables.” In our case, there are 3,986 observations (e.g.,
respondents) and 989 variables.
:::
...
::: notes
1.   Render code-along-01. Help from TA if needed.  
2.   Download Milestone 01. Can't complete until next week. But, can install and load packages.  
3.   Work on the IPUMS section of MS01!
:::
