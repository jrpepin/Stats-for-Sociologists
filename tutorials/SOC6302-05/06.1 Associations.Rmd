...
A graph depicting an interval-ratio independent variable and an interval-ratio dependent variable.
:::

A scatterplot shows the relationship between two interval-ratio variables. 
Each dot represents an observation in the data. 
Typically, the x-axis contains the independent variable and the y-axis contains the dependent variable.  
