...
A.  Use `zap_missing()`, `as_factor()`, and `droplevels()` to make `sex`
...
-   "Part-time" if `hrs1` is equal to or more than 1 and equal to or
    less than 34
...
# Run this code to create change variables
