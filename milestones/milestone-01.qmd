...
Convert the `fefam` variable to a factor variable. Make sure you remove
any 'missing' (NA) or empty (e.g., levels with no observations) levels.

## Question 06

Create a (pretty) relative frequency table to show for the `fefam`
variable using the 2024 data. How many respondents "strongly agree" with
the `fefam` statement in 2024? What % of respondents either "strongly
agree" or "agree"?
...
levels). Were most respondents "not too happy," "pretty happy," or "very
happy" in 2024?
...
interpretation. How many women were `very happy`? How many men were
`very happy`?
