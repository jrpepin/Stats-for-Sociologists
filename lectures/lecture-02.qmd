...
::: task
{{< fa check-double >}} Load the 2024 GSS data & all survey waves.
:::
...
::: notes
Statistical variable types describe the meaning of the data (e.g., nominal = categories, continuous = measurements).  
R variable types describe how the data is stored in memory (factor, numeric, character, etc.).  
:::
