...
**MAC Users**: Download and install this: [https://www.xquartz.org/](https://www.xquartz.org/)
:::
...
## Mini-task {data-menu-title=" R-scripts (& Quarto)"}
...
## Mini-task {data-menu-title="Create a RStudio Project"}
...
Copy and paste the following code into your [Console pane]{style="color: #F39C12;"}. 
Then hit "Enter".
...
## Mini-task {data-menu-title="Install `tinytex()`"}
...
The variable names are case sensitive. In this dataset, all variables
are lowercase.
...
2,436 respondents were coded as `1` on this variable. What does that
mean?
:::
