...
Download and open
[code-along-03.qmd](https://app.filen.io/#/d/6a48af14-24e7-4b4f-9590-9621ebe66a1c%23gpEqta93355mnpNJF3Tu630dxHehnQzr)
...
::: task
{{< fa check-double >}} Create a dataframe with the variables `year`, `sex`,
`hrs1`, and `childs` for only the 2024 respondents without missing data
for `sex`, `hrs1`, and `childs`.
:::
