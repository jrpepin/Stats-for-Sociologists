...
## Tour: RStudio Panes {background-image="images/file-video-solid.png" background-size="100px" background-repeat="repeat"}
...
## Tour: Quarto {background-image="images/file-video-solid.png" background-size="100px" background-repeat="repeat"}
...
There's no command in the R console to save scripts— 
