...
The coefficient for `sex: female` is $−1.02$. This is the difference in the outcome between women and men when education = 0. Women score 1.02 units lower than men at zero education, but this difference is not statistically significant (p = 0.214).
