...
dataL02$degree <- factor(dataL02$degree,
  levels = c(
    "Less than high school", "High school", "Associate/Junior college",
    "Bachelor's", "Graduate"
  ), ordered = FALSE
)
...
gss_all$degree <- factor(gss_all$degree,
  levels = c(
    "High school", "Less than high school", "Associate/Junior college",
    "Bachelor's", "Graduate"
  ), ordered = FALSE
)
