...
::: task
{{< fa check-double >}} Install the [`Rmisc()`](https://cran.r-project.org/web/packages/Rmisc/refman/Rmisc.html) package, available on CRAN.
:::
...
::: task
{{< fa check-double >}} Load the standard packages and our new `Rmisc()` package.
:::
...
::: aside
We'll use `Rmisc()` to calculate confidence intervals with `summarize()`.  
:::
