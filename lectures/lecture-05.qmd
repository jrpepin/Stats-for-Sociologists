...
::: task
{{< fa lightbulb >}} Based on the 95% confidence interval for the average number of internet hours in 2022, what can we infer about the population mean? 
:::
...
wwwhr_ci99 <- gss22 |>
  ...
  summarise(
    ...
    mean = mean(wwwhr),
    sd = sd(wwwhr),
    lowCI = CI(wwwhr, ci = 0.99)['lower'],
    hiCI  = CI(wwwhr, ci = 0.99)['upper']
    )
...
## Compare confidence intervals {.sparse-slide}
