...
3.  Returns a logical vector (TRUE, FALSE, or NA) and \* 1 converts it
    to numeric
...
-   use `mutate()` to create a character variable with 4 categories: 1
    child, 2 children, 3 children, 4 or more children (and
