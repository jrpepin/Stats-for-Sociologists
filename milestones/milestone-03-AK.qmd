...
-    Pick or create a dichotomous variable (e.g., gender, two racial cateogires; two age categories; two countries; two years; etc.) in your dataset and create confidence intervals for each group for your DV. Compare and interpret the confidence intervals.
