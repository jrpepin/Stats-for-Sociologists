...
Download and open [code-along-04.qmd](https://www.dropbox.com/scl/fi/5jrxot2fr5p6v3xggr86h/code-along-04.qmd?rlkey=5okcd4ofidkxhwbffhb2hknz3&dl=1)
...
::: task
{{< fa check-double >}} Use `tail()` to look at the last few rows of
`my_data`
:::
...
`agekdbrn`, `childs`, and `hrs1`, including only respondents from the
year 2022 who have no missing values in any of these variables.
:::
...
[Never overwrite your raw
dataset!]{style="color: #E74C3C; font-size: 175%; font-family: 'Shadows Into Light'"}
...
`marital`: Are you currently – married, widowed, divorced, separated, or
