...
[{{< fa regular lightbulb >}} **Are beliefs about premarital sex (`premarsx`) dependent on political identity (`polviews`)?**]{style="color: #F39C12; font-size: 100%; font-family: 'Shadows Into Light'"}

<br>

. . .

[{{< fa regular lightbulb >}} **Is there a gender difference (`sex`) in political identity (`polviews`)?**]{style="color: #F39C12; font-size: 100%; font-family: 'Shadows Into Light'"}

<br>

. . .

[{{< fa regular lightbulb >}} **Describe the relationship between age and life satisfaction.**]{style="color: #F39C12; font-size: 100%; font-family: 'Shadows Into Light'"}
