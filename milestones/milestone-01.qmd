...
chunks) where appropriate. Add narrative (outside code chunks) or
comments (inside the code chunks) throughout. Justify your answers.*

## Checkpoint 01

Report the survey question that corresponds to the `fefam` variable. How
did you find out?

## Checkpoint 02

Is `fefam` a dichotomous, nominal, ordinal, or interval-ratio variable?
Justify your answer.
...
Which years of the survey did the `fefam` variable appear in the GSS?
...
If a respondent has a value of `4` for the `fefam` variable, what does
that mean?
...
Use `freq()` to create a (pretty) relative frequency table to show for the `fefam`
variable using the 2024 data. 
...
How many respondents "strongly agree" with the `fefam` statement in 2024? 
What % of respondents either "strongly agree" or "agree"?
...
Were most respondents "not too happy," "pretty happy," or "very happy" in 2024?
...
What percentage of women were `very happy`? How percentage of men were
`very happy`?

## Checkpoint 09

Using the table above, were a greater percentage of women or men `not too happy` in 2024?
