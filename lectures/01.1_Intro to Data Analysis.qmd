...
[Are women more likely than men to say premarital sex is "**not wrong at all**?"]{style="color: #E74C3C; font-size: 150%; font-family: 'Shadows Into Light'"}  
...
table_premarsx %>%
  ...
  color(color = "white", part = "header") %>%
  fontsize(size = 22, part = "all") %>%
  color(color = "#E74C3C", i = 1, j = "female") %>%
  color(color = "#E74C3C", i = 1, j = "male")

```


::: aside
[*Source: U.S. General Social Survey 1972-2024*]{style="color: $gray-500"}
:::
