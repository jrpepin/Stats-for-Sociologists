...
# hidding error when rendering
orig_freq <- summarytools::freq
...
household pushes the average far above what’s typical: **\$70,900**]{.shadows-text style="color: #F39C12;"}  
...
To find the median using a frequency table, you locate the value or category where the cumulative percentage first reaches or exceeds 50%. Here's an example: 

**Percentage distribution of opinion on whether the demands of job
...
gss_all$wkvsfam <- gss_all$wkvsfam |>
  haven::zap_missing() |>
  haven::as_factor() |>
  forcats::fct_rev()
...
["`Rarely`" is the median, because half of the data lie below it and half lie above it.]{.shadows-text style="color: #F39C12;"}
...
Could you say in regular words what is the median in this historgram?
...
[The median age at which people had their first child is 24 years old. This means that half of the people had their first child before age 24, and the other half had their first child at age 24 or older.]{.shadows-text style="color: #F39C12;"}
...
[*Source: U.S. General Social Survey 2024*]{style="color: $gray-300; font-size: 80%"}
...
[The mode is "`looking out for themselves`," because it was the response chosen by the greatest percentage of people in the survey.]{.shadows-text style="color: #F39C12;"}
...
[*Source: U.S. General Social Survey 1976-2024*]{style="color: $gray-300; font-size: 80%"}
