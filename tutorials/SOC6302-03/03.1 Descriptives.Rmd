...
Let's use `R` to calculate the median. Change the function `mean` to `median`.  
Then, click the `Run Code` button below. When you're satisfied with your code, click **`Submit Answer.`**
...
::: {#median01-hint}
**Hint:** Replace the text "mean" with the text "median".
:::
...
Replace the blank line with `fairearn` and click the `Run Code` button to create a relative frequency table for this variable. When you're satisfied with your code, click **`Submit Answer.`**
...
Replace the blank line with `range` and click the `Run Code` button. When you're satisfied with your code, click **`Submit Answer`**.
...
Replace the blank line with `my_data` and click the `Run Code` button. When you're satisfied with your code, click **`Submit Answer.`**
...
Use the `sd()` with `my_data` and click the `Run Code` button. When you're satisfied with your code, click **`Submit Answer.`**
