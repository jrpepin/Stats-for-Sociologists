...
Replication using technology requires researchers to use sometimes
...
::: {style="color: #18BC9C; font-size: 75%; font-family: 'Shadows Into Light'"}
“Grappling is like perseverance, but it goes beyond that. Perseverance
means trying again and again, even after you’ve failed. Grappling
implies trying even before you fail the first time.
...
## When you get stuck, there are many options to get unstuck
...
[**Search for answers before posting your question.**]{style="color: #18BC9C;"}\
...
Or, if you solve it on your own, post how you solved it.


## Help in this class
  
In this class, the fastest way to get help on Lab Assignments is during class 
time and lab sessions.  

<br>  

The second fastest way is to post your reproducible example on the class 
discussion board.  
